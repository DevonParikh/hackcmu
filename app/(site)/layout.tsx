...
/** Header and footer for the owner-facing pages. Hosted tools at /t/[slug] keep the bare root layout. */
      ...
      <header className="site-header">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-5 py-3">
          <Link href="/" className="brand" aria-label="Tailor home">
            ...
            <span className="display">Tailor</span>
          </Link>
      ...
      <footer className="site-footer">
        <div className="mx-auto grid max-w-6xl gap-8 px-5 py-10 md:grid-cols-[1.4fr_1fr_1fr_1fr]">
          ...
          <div className="footer-col">
            ...
            <span className="text-muted">Built at HackCMU</span>
          </div>
        </div>
