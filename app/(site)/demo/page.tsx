    ...
    <main className="mx-auto max-w-6xl px-5 py-12 md:py-16">
      <div className="grid gap-10 md:grid-cols-[1fr_1.2fr] md:gap-14">
        <section>
          ...
          <h1 className="display mt-2 text-4xl font-semibold leading-tight md:text-5xl" style={{ textWrap: "balance" }}>
          ...
          <ol className="steps mt-6">
            ...
            <li>
              <b>Minute 5 to 15.</b> The report: the chore that costs the most, with the evidence.
            </li>
            <li>
              <b>Minute 15 to 20.</b> The assistant, self-tested, and how it goes on your site.
            </li>
          </ol>
